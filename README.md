...
Ans: JSX stands for JavaScript XML. It lets us write HTML-like code directly inside JavaScript.
...
Ans: State is data that a component owns and controls. It can change while the app is running.
...
Ans: useState is a built-in React Hook that lets functional components have their own state.
...
Ans: To share state between components, you usually lift the state up to the closest parent component.
...
Ans: React handles events almost like JavaScript but with a few differences:
